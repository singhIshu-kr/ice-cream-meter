...
describe('User Page reducer', () => {
  it('should return the isTeamCreated field as true on TEAM_CREATED action', () => {
    ...
    let expectedState = { "activeElement": "team_list", "errorMessage": "", "infoMessage": "", "invalidName": false, "newTeam": undefined, "searchedTeam": "", "teams": [], "userId": "" };
  ...
  it('should return the default state when action does not match', () => {
    ...
    let expectedState = { "activeElement": "team_list", "errorMessage": "", "infoMessage": "", "invalidName": false, "newTeam": null, "searchedTeam": "", "teams": [], "userId": "" };
    expect(updateUserPage(undefined, action)).toEqual(expectedState);
  });
  ...
  it('should return the list of all the teams on GET_TEAMS_OF_USER', () => {
    ...
    let expectedState = { "activeElement": "team_list", "errorMessage": "", "infoMessage": "", "invalidName": false, "newTeam": null, "searchedTeam": "", "teams": [{ "role": "ADMIN", "teamId": "1234", "userId": "abcd" }], "userId": "" };
    expect(updateUserPage(undefined, action)).toEqual(expectedState);
  });

  it('should return the name of the searchedTeam on SEARCH_TEAM action', () => {
    let action = { type: types.SEARCH_TEAM, searchedTeam: "abcd"};
    let expectedState = { "activeElement": "team_list", "errorMessage": "", "infoMessage": "", "invalidName": false, "newTeam": null, "searchedTeam": "abcd", "teams": [], "userId": "" };
    expect(updateUserPage(undefined, action)).toEqual(expectedState);
  });

  it('should return invalidName as true on TEAM_DOESNOT_EXIST action', () => {
    let action = { type: types.TEAM_DOESNOT_EXIST};
    let expectedState = { "activeElement": "team_list", "errorMessage": "Invalid Name", "infoMessage": "", "invalidName": true, "newTeam": null, "searchedTeam": "", "teams": [], "userId": "" };
    expect(updateUserPage(undefined, action)).toEqual(expectedState);
  });
});
