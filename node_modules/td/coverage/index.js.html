  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>105/173</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">46.15% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>48/104</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>93/159</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L840'></a><a href='#L840'>840</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
        ...
        key: 'updateSchema',
        value: function <span class="fstat-no" title="function not covered" >updateSchema(</span>db, table, schema_json, callback) {
<span class="cstat-no" title="statement not covered" >            this._request("/v3/table/update-schema/" + _querystring2.default.escape(db) + "/" + _querystring2.default.escape(table), {</span>
                method: 'POST',
                body: schema_json,
                json: true
            }, callback);
        ...
        key: 'tail',
        value: function <span class="fstat-no" title="function not covered" >tail(</span>db, table, count, to, from, callback) {
...
<span class="cstat-no" title="statement not covered" >                count = null;</span>
            } else <span class="cstat-no" title="statement not covered" >if (typeof to === 'function') {</span>
...
<span class="cstat-no" title="statement not covered" >                to = null;</span>
            } else <span class="cstat-no" title="statement not covered" >if (typeof from === 'function') {</span>
<span class="cstat-no" title="statement not covered" >                callback = from;</span>
...
<span class="cstat-no" title="statement not covered" >                params.count = count;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (to) {</span>
<span class="cstat-no" title="statement not covered" >                params.to = to;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (from) {</span>
<span class="cstat-no" title="statement not covered" >                params.from = from;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            this._request("/v3/table/tail/" + _querystring2.default.escape(db) + "/" + _querystring2.default.escape(table), {</span>
                method: 'GET',
                qs: params
            }, callback);
        }
...
&nbsp;
        ...
        value: function listJobs(from, to, status, conditions, callback) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof from === 'function') {
                callback = from;
                from = 0;
            } else <span class="cstat-no" title="statement not covered" >if (typeof to === 'function') {</span>
<span class="cstat-no" title="statement not covered" >                callback = to;</span>
<span class="cstat-no" title="statement not covered" >                to = null;</span>
            } else <span class="cstat-no" title="statement not covered" >if (typeof status === 'function') {</span>
...
&nbsp;
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (to) {
<span class="cstat-no" title="statement not covered" >                params.to = to;</span>
            }
...
<span class="cstat-no" title="statement not covered" >                params.status = status;</span>
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (conditions) {
<span class="cstat-no" title="statement not covered" >                params.conditions = conditions;</span>
            }
&nbsp;
...
&nbsp;
        ...
        key: 'export',
        value: function <span class="fstat-no" title="function not covered" >_export(</span>db, table, storage_type, opts, callback) {
...
<span class="cstat-no" title="statement not covered" >            opts.storage_type = storage_type;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            this._request("/v3/export/run/" + _querystring2.default.escape(db) + "/" + _querystring2.default.escape(table), {</span>
                method: 'POST',
                body: opts,
                json: true
            }, callback);
...
&nbsp;
        ...
        value: function createSchedule(name, opts, callback) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!opts.cron || !opts.query) {
<span class="cstat-no" title="statement not covered" >                return callback(new Error('opts.cron and opts.query is required!'), {});</span>
            }
            opts.type = 'hive';
...
&nbsp;
        ...
        key: 'history',
        value: function <span class="fstat-no" title="function not covered" >history(</span>name, from, to, callback) {
<span class="cstat-no" title="statement not covered" >            if (typeof from === 'function') {</span>
<span class="cstat-no" title="statement not covered" >                callback = from;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            this._request("/v3/schedule/history/" + _querystring2.default.escape(name), {</span>
                method: 'GET',
                qs: params,
                json: true
            }, callback);
        ...
        value: function runSchedule(name, time, num, callback) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof num === 'function') {
                callback = num;
                num = null;
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                params.num = num;</span>
            }
&nbsp;
...
&nbsp;
        ...
        key: 'import',
        value: function <span class="fstat-no" title="function not covered" >_import(</span>db, table, format, stream, size, unique_id, callback) {
<span class="cstat-no" title="statement not covered" >            if (typeof unique_id === 'function') {</span>
<span class="cstat-no" title="statement not covered" >                callback = unique_id;</span>
<span class="cstat-no" title="statement not covered" >                unique_id = null;</span>
            }
&nbsp;
            var path = <span class="cstat-no" title="statement not covered" >void 0;</span>
<span class="cstat-no" title="statement not covered" >            if (unique_id) {</span>
<span class="cstat-no" title="statement not covered" >                path = "/v3/table/import_with_id/" + _querystring2.default.escape(db) + "/" + _querystring2.default.escape(table) + "/" + _querystring2.default.escape(unique_id) + "/" + _querystring2.default.escape(format);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                path = "/v3/table/import/" + _querystring2.default.escape(db) + "/" + _querystring2.default.escape(table) + "/" + _querystring2.default.escape(format);</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            this._put(path, {</span>
                method: 'PUT',
                headers: {
...
&nbsp;
        ...
        key: 'listResult',
        value: function <span class="fstat-no" title="function not covered" >listResult(</span>callback) {
<span class="cstat-no" title="statement not covered" >            this._request("/v3/result/list", {</span>
                json: true
            }, callback);
        }
    }, {
        key: 'createResult',
        value: function <span class="fstat-no" title="function not covered" >createResult(</span>name, url, callback) {
<span class="cstat-no" title="statement not covered" >            this._request("/v3/result/create/" + _querystring2.default.escape(name), {</span>
                method: 'POST',
                body: { 'url': url },
                json: true
            }, callback);
        ...
        key: 'deleteResult',
        value: function <span class="fstat-no" title="function not covered" >deleteResult(</span>name, url, callback) {
<span class="cstat-no" title="statement not covered" >            this._request("/v3/result/delete/" + _querystring2.default.escape(name), {</span>
                method: 'POST',
                body: { 'url': url },
                json: true
            }, callback);
...
&nbsp;
        ...
        key: 'serverStatus',
        value: function <span class="fstat-no" title="function not covered" >serverStatus(</span>callback) {
<span class="cstat-no" title="statement not covered" >            this._request("/v3/system/server_status", {</span>
                json: true
            }, callback);
        }
&nbsp;
...
&nbsp;
                if (res.statusCode &lt; 200 || res.statusCode &gt; 299) {
                    return callback(new Error(body &amp;&amp; body.error || <span class="branch-2 cbranch-no" title="branch not covered" >'HTTP ' + res.statusCode)</span>, body || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
                }
&nbsp;
                callback(null, body || {});
            });
...
<span class="cstat-no" title="statement not covered" >                    return callback(err, undefined);</span>
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (res.statusCode &lt; 200 || res.statusCode &gt; 299) {
<span class="cstat-no" title="statement not covered" >                    return callback(new Error(body &amp;&amp; body.error || 'HTTP ' + res.statusCode), body || {});</span>
                }
&nbsp;
                callback(null, body || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
            }));
        }
    }]);
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sat Jun 23 2018 10:57:31 GMT+0900 (JST)
</div>
</div>
